                        ...
                        <div class="row">
                            ...
                            <form action="" method="GET">
                                    <div class="input-group mb-3">
                                        <input type="text" name="inpp" required  class="form-control" placeholder="SKILL-Req">
                                        <input type="number" step=0.01 name="inp" required  class="form-control" placeholder="Job-Id">
                                        <input type="number" step=0.01 name="inppp" required  class="form-control" placeholder="Percentage">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    {
                                        $filtervalues = $_GET['inpp'];
                                        $id=$_GET['inp'];
                                        $per=$_GET['inppp'];
                                   
                                    $query=("call final1('$filtervalues',$id,$per)");
